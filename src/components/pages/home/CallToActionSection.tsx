export const CallToActionSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="relative w-fit -mt-px font-['Roobert-SemiBold',Helvetica] font-semibold text-[#121e36] text-[17px] tracking-[-0.34px] leading-[normal] whitespace-nowrap">
          {buttons[0].text}
        </span>
      </button>
      ...
      >
        <span className="relative w-fit mt-[-6.00px] mb-[-4.00px] font-['Roobert-SemiBold',Helvetica] font-semibold text-white text-[17px] tracking-[-0.34px] leading-[normal] whitespace-nowrap">
          {buttons[1].text}
        </span>
      </button>
    </nav>
