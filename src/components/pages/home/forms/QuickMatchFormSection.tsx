export const QuickMatchFormSection = () => {
  return (
    <div className="flex flex-col w-full max-w-md lg:max-w-[510px] items-center gap-6 p-6 md:p-8 relative rounded-[32px] border-[none] bg-[linear-gradient(325deg,rgba(40,60,100,1)_60%,rgba(59,124,126,1)_100%)] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-[32px] before:[background:linear-gradient(142deg,rgba(40,60,100,1)_60%,rgba(59,124,126,1)_100%) before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:mask-exclude before:z-1 before:pointer-events-none shadow-2xl">
      ...
      <div className="absolute inset-0 z-50 backdrop-blur-sm rounded-[32px] md:p-8 p-6 flex items-center justify-center">
        <div className="box-border flex w-full sm:w-[182px] items-center justify-center gap-2.5 pt-4 pb-[18px] px-[160px] relative flex-[0_0_auto] rounded-[29px] bg-[linear-gradient(106deg,rgba(165,215,171,1)_0%,rgba(147,195,195,1)_100%)] shadow-lg -rotate-12">
          <div className="relative w-fit -mt-px font-['Roobert-SemiBold',Helvetica] font-bold text-[#121e36] text-[40px] tracking-[-0.34px] leading-[normal] whitespace-nowrap">
            COMING SOON
          </div>
        </div>
      </div>
