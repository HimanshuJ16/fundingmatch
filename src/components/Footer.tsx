      ...
      <div className="container mx-auto px-4 max-w-[1224px] flex flex-col gap-12 relative">
        ...
        <div className="flex flex-col items-start gap-8">
          <img
            ...
            src="assets/logo.png"
          />
          <p className="max-w-[962px] text-[#ffffffcc] text-base md:text-lg leading-relaxed font-['Roobert-Regular',Helvetica]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-20">
          ...
          <div className="flex flex-col items-start gap-8">
            <address className="not-italic flex flex-col items-start gap-6 text-[#ffffffcc]">
              <div className="text-base md:text-lg leading-relaxed font-['Roobert-Regular',Helvetica]">
                <span className="block font-medium text-white mb-2 font-['Roobert-Medium',Helvetica]">
                  EFG Group Ltd
                </span>
                <span>
          ...
          <div className="flex gap-12 md:gap-24 w-full lg:w-auto">
            ...
            >
              <h2 className="text-xl font-semibold text-white font-['Roobert-SemiBold',Helvetica]">
                Legal
              </h2>
        ...
        <div className="pt-8 border-t border-[#f8f4f133] flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-[#ffffffcc] text-sm md:text-base opacity-50 font-['Roobert-Regular',Helvetica]">
